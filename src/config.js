...
export const S3_BUCKET_NAME = 'chatapp3';
export const AWS_ACCESS_KEY = 'AKIAUI4YW2OLV2EGTIES';
export const AWS_SECRET_ACCESS_KEY = '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';
